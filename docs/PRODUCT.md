...
**Status:** fase 4 em andamento — Clips, QR e Freeze com OCR prontos. Em seguida Links e Kill. `v0.1` publicado com as fases 1 e 2. Este documento é a fonte de verdade até o primeiro release.
